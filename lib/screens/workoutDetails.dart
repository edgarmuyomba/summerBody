            ...
            builder: (context, state) {
              if (state is WorkoutReady) {
                return FutureBuilder(
                    future: widget._sharedPreferencesService
                        .getStringValue("gender"),
                    builder: (context, asyncSnapshot) {
                      String gender = asyncSnapshot.data ?? "male";
                      return Padding(
                          ...
                          child: SingleChildScrollView(
                            child: Column(
                              ...
                              children: [
                                ...
                                if (state.workout.subMuscles?.isNotEmpty ==
                                    true) ...[
                                  SizedBox(
                                    height: 20.h,
                                  ),
